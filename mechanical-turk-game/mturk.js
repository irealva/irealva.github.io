...
$(document).ready(function () {
  ...
  if((aid = gup("assignmentId"))!="" && $(form_selector).length>0) {
    ...
    var aid_input = $("<input type='hidden' id='elapsedTime' name='elapsedTime' value='" + time + "'>").appendTo($(form_selector));
    var aid_input = $("<input type='hidden' id='reward' name='reward' value='" + reward + "'>").appendTo($(form_selector));
